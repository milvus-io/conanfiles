...
if __name__ == "__main__":
    ...
    system("conan export google-cloud-cpp/all google-cloud-cpp/2.5.0@milvus/2.4")
    system("conan export googleapis/all googleapis/cci.20221108@")
    system("conan export grpc/all grpc/1.50.1@milvus/dev")
    ...
    system("conan export opentelemetry-cpp/all opentelemetry-cpp/1.8.1.1@milvus/2.4")

...
# Set the dependency flags expected by https://github.com/facebook/folly/blob/v2024.08.12.00/CMake/folly-deps.cmake
...
if (NOT MSVC)
    ...
    # libdwarf 0.5+ installs dwarf.h under include/libdwarf/ subdirectory
    foreach(dir ${LIBDWARF_INCLUDE_DIRS})
        if (IS_DIRECTORY "${dir}/libdwarf")
            include_directories("${dir}/libdwarf")
        endif()
    endforeach()
endif()

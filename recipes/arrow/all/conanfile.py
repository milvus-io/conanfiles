...
class ArrowConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["libarrow"].set_property("cmake_build_modules", [self._module_file_rel_path])
        ...
        if self.options.parquet:
            ...
            self.cpp_info.components["libparquet"].set_property("cmake_build_modules", [self._module_file_rel_path])
        ...
        if self.options.get_safe("substrait"):
            ...
            self.cpp_info.components["libarrow_substrait"].set_property("cmake_build_modules", [self._module_file_rel_path])
        ...
        if self.options.gandiva:
            ...
            self.cpp_info.components["libgandiva"].set_property("cmake_build_modules", [self._module_file_rel_path])
        ...
        if self.options.with_flight_rpc:
            ...
            self.cpp_info.components["libarrow_flight"].set_property("cmake_build_modules", [self._module_file_rel_path])
        ...
        if self.options.get_safe("with_flight_sql"):
            ...
            self.cpp_info.components["libarrow_flight_sql"].set_property("cmake_build_modules", [self._module_file_rel_path])

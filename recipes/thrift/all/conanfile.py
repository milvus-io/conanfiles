...
class ThriftConan(ConanFile):
    ...
    def package_info(self):
        ...
        if self.options.with_zlib:
            ...
            self.cpp_info.components["libthrift_z"].set_property("cmake_build_modules", [self._module_file_rel_path])
        ...
        if self.options.with_libevent:
            ...
            self.cpp_info.components["libthrift_nb"].set_property("cmake_build_modules", [self._module_file_rel_path])
        ...
        if self.options.with_qt5:
            ...
            self.cpp_info.components["libthrift_qt5"].set_property("cmake_build_modules", [self._module_file_rel_path])

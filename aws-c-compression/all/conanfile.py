...
class AwsCCompression(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["aws-c-compression-lib"].names[
            "cmake_find_package"
        ] = "aws-c-compression"
        self.cpp_info.components["aws-c-compression-lib"].names[
            "cmake_find_package_multi"
        ] = "aws-c-compression"
        self.cpp_info.components["aws-c-compression-lib"].set_property(
            "cmake_target_name", "AWS::aws-c-compression"
        )
        self.cpp_info.components["aws-c-compression-lib"].requires = [

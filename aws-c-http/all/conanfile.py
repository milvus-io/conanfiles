...
class AwsCHttp(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("aws-c-compression/0.2.15@milvus/dev")
    ...
    def package_info(self):
        ...
        self.cpp_info.components["aws-c-http-lib"].set_property(
            "cmake_target_name", "AWS::aws-c-http"
        )
        self.cpp_info.components["aws-c-http-lib"].names[
            "cmake_find_package"
        ] = "aws-c-http"
        self.cpp_info.components["aws-c-http-lib"].names[
